...
import { Download, QrCode, Shield, CheckCircle, Printer } from 'lucide-react';
  ...
  return (
    <DashboardLayout role="citizen" userName="Tahir Raza">
      ...
      <div className="glass-card p-4 border border-green-400/30 bg-green-400/5 flex items-center gap-3 mb-6">
        ...
        <span className="font-mono text-cyan-400 text-xs border border-cyan-400/30 px-2 py-1 rounded-lg">CRT-2025-041789</span>
      </div>

      {/* Certificate */}
      <div className="flex justify-center">
        <div ref={certRef} className="w-full max-w-2xl certificate-bg rounded-3xl overflow-hidden shadow-2xl print:shadow-none">
          {/* Header band */}
          <div className="bg-gradient-to-r from-[#003580] to-[#00529b] px-8 py-5 flex items-center justify-between">
            <div className="flex items-center gap-4">
              {/* Pakistan Emblem placeholder */}
          ...
          <div className="px-8 py-8 bg-gradient-to-b from-[#f8f4e8] to-[#fff8e8]">
            ...
            <div className="text-[#2c3e50] leading-relaxed mb-8">
              ...
              <div className="bg-white/70 rounded-2xl p-6 border border-[#003580]/10 mb-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ['Full Name',    'Tahir Raza'],
                    ["Father's Name",'Muhammad Khalid Khan'],
            ...
            <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-xl p-3 mb-8">
              ...
              <div className="flex-1">
                <p className="text-green-800 font-semibold text-xs">AI Verified — Confidence: 97.4%</p>
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              ...
              <div className="text-center">
                ...
                <p className="text-[#003580]/50 text-xs">Gulberg PS, Lahore</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-[#003580]/50 text-xs">Punjab Police</p>
              </div>
            </div>

            {/* Footer */}
            <div className="mt-8 pt-4 border-t-2 border-dashed border-[#003580]/20 text-center">
              <div className="flex justify-center gap-6 text-xs text-[#003580]/50 flex-wrap">
                <span>Issue Date: 06 May 2025</span>
                <span>Valid Until: 06 November 2025</span>
                <span>Ref: PV-2025-0041</span>
              </div>
              <p className="text-[#003580]/30 text-xs mt-2">
                This is a computer-generated certificate. Verify at: pakverify.gov.pk | Helpline: 0800-12345
              </p>
            </div>
          </div>

          {/* Bottom band */}
          <div className="bg-gradient-to-r from-[#003580] to-[#00529b] px-8 py-3 flex items-center justify-between">
            <span className="text-white/60 text-xs font-mono">CRT-2025-041789</span>
            <div className="flex items-center gap-1.5 text-white/80 text-xs">
              <Shield size={12}/> AI-Powered Verification
            </div>
